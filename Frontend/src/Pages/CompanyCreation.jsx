				...
				<form action="">
					<div className="flex leading-4">
						...
						<input
							...
							className="h-[18px] text-[14px] font-semibold outline-0 focus:border focus:border-blue-400 focus:bg-amber-200 pl-0.5"
						/>
					</div>
					...
					<div className="flex leading-4">
						...
						<input
							...
							autoComplete="off"
							onChange={changeHandler}
							className="h-[18px] text-[14px] ml-4 font-semibold outline-0 focus:border focus:border-blue-400 focus:bg-amber-200 pl-0.5"
						/>
					</div>
					<div className="flex leading-4">
