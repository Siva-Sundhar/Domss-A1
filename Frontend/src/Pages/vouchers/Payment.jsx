...
import PaymentSub from "../PaymentSub.jsx";
			...
			<div className="bg-[#fffaf4] h-screen">
				...
				<div className="flex">
					...
					<div className="text-right w-[15%]">
						<div>
							<h1 className="text-[14px] font-semibold border-t border-double border-b-4 border-slate-400 pr-0.5">
								25000.00
							</h1>
						</div>
					</div>
